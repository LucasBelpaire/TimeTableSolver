...
def get_random_time_slots():
    ...
    """
    time_slot_1 = random.randrange(gi.generalInfo.total_course_hours)
    time_slot_2 = random.randrange(gi.generalInfo.total_course_hours)
...
def get_random_positions():
    ...
    """
    position_1 = random.choice(list(gi.time_table))
    position_2 = random.choice(list(gi.time_table))
...
def swap_positions(position_1, position_2, feasibility=True):
    ...
    if feasibility:
        ...
        gi.remove_course_from_position(position_1)
        gi.remove_course_from_position(position_2)
        gi.assign_course_to_position(event_1, position_2)
        gi.assign_course_to_position(event_2, position_1)
        return True
    ...
    if event_1 is not None:
        ...
        if swap_possible:
            ...
            gi.unplaced_events.append(event_1)
    if event_2 is not None:
        swap_possible = hc.course_event_fits_into_time_slot(event_2, time_slot_1) and hc.room_capacity_constraint(event_2, room_1)
        if swap_possible:
            gi.assign_course_to_position(event_2, position_1)
        else:
            gi.unplaced_events.append(event_2)
    return True
